...
subdomains_recon(){
    if [ -d "${tmp_dir}" ]; then
        ...
        source_files=(alienvault.sh amass.sh bruteforce.sh builtwith.sh certspotter.sh commoncrawl.sh crt.sh dnsdumpster.sh dnsrepo.sh \
            hackertarget.sh katana.sh netcraft.sh rapiddns.sh securitytrails.sh shodan.sh subfinder.sh tlsx.sh urlfinder.sh urlscan.sh \
