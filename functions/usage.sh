...
usage(){
    ...
    echo -e "\t-e  |--exclude-domains      - Specify excluded subdomains after all treated files, ${red}used only with${reset} ${yellow}-d|--domain${reset}:"
    ...
    echo -e "\t\t\t\t      After the use the collector with the recon-only option (${yellow}-r${reset} OR ${yellow}--recon${reset}) you can use this option (${yellow}-wd${reset} OR ${yellow}--web-data${reset}) retrieve information from the web application:"
    ...
    echo -e "\t-ww |--web-wordlists        - Specity more wordlists to put in web_wordlist array as the first wordlist to enumerate dirs and files from website."
