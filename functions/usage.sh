...
usage(){
    ...
    echo -e "\t-vc |--vhost-check            - Will execute vhost_check and vhost_probe against live IPs to discover virtual hosts."
    ...
    echo -e "\t-wd |--webapp-discovery       - Will execute the function webapp_alive, ${yellow}execute only with the -r|--recon and -wsd|--webapp-short-detection, -wld|--webapp-long-detection, or -wcp|--webapp-common-ports options${reset},"
    ...
    echo -e "\t-wcp|--webapp-common-ports    - Will probe the union of webapp_http_ports and webapp_tls_ports (conf.d/functions.conf) — the plain-HTTP and TLS ports whose protocol is fixed by convention."
    echo -e "\t-wld|--webapp-long-detection  - Will execute the full port list: webapp_http_ports + webapp_tls_ports + webapp_multiple_ports (conf.d/functions.conf) — the comprehensive/slow option."
    echo -e "\t-wsd|--webapp-short-detection - Will execute the list of ports setup in conf.d/functions.conf as variable webapp_http_ports (ports fixed as plain HTTP by convention)."
