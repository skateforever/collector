...
usage(){
    ...
    echo -e "\t-we |--web-enum             - By default, a function called webapp_enum will be executed, ${red}unless${reset} the collector is run recon-only option (${yellow}-r${reset} OR ${yellow}--recon${reset})."
