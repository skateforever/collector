...
usage(){
    ...
    echo -e "\t                                ${yellow}Note:${reset} to stop a running collector, use ${yellow}docker stop <container>${reset} on the host."
    ...
    echo -e "\t                                ${yellow}Note:${reset} Output directory is fixed at ${yellow}/opt/collector/outputs${reset} inside the container."
