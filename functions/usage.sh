...
usage(){
    ...
    echo -e "\t-wld|--webapp-long-detection  - Will execute the long list of ports setup in conf.d/functions.conf as variable web_port_long_detection."
    echo -e "\t-wsd|--webapp-short-detection - Will execute the short list of ports setup in conf.d/functions.conf as variable web_port_short_detection."
