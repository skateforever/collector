...
usage(){
    ...
    echo -e "       ${yellow}$0${reset} ${green}-d domain.com --recon --webapp-discovery --webapp-short-detection --webapp-enum --webapp-wordlists /path/file/wordlist.txt${reset}"
    echo -e "       ${yellow}$0${reset} ${green}-dl /path/file/domain_list.txt --recon --webapp-discovery --webapp-short-detection${reset}"
    echo -e "       ${yellow}$0${reset} ${green}-dl /path/file/domain_list.txt --recon --webapp-discovery --webapp-short-detection --webapp-enum --webapp-wordlist /path/file/wordlist.txt${reset}"
    echo ""
    echo "Options: "
    ...
    echo -e "\t-wd |--webapp-discovery       - Will execute the function webapp_alive, ${yellow}execute only with the -r|--recon and -wsd|--webapp-short-detection or --wld|--webapp-long-detections options${reset},i"
