...
usage(){
    ...
    echo -e "\t-wd |--webapp-discovery       - Will execute the function webapp_alive, ${yellow}execute only with the -r|--recon and -wsd|--webapp-short-detection or --wld|--webapp-long-detections options${reset}, without this option the collector will reduce time execution."
    echo -e "\t                                Without this option you will receive only domains and subdomains"
