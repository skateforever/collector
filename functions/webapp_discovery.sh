...
webapp_alive(){
    ...
    echo -e "${yellow}$(date +"%d/%m/%Y %H:%M")${reset} ${red}>>${reset} Initializing the web application discovery..."
    echo -e "\t\t    ${red}Warning:${reset} It can take a long time to execute the this discovery function!"
