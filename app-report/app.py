...
def index():
    ...
    totals = query_one(
        ...
        SELECT
            ...
            COALESCE(SUM(webapp_consolidated), 0)       AS webapp_consolidated,
...
def target_detail(domain: str):
    ...
    chart = {
        ...
        "webapp_consolidated": [r["webapp_consolidated"] or 0 for r in trend],
...
RAW_FILES: dict[str, dict] = {
    ...
    "llm_prompt":        {"path": ("llm-prompt.txt",),                   "label": "LLM prompt"},
